...
class GraphList extends Component {
    ...
    render() {
        const { graphs, date, time, heartRateAvg, bodyTemperatureAvg, sbpAvg, dbpAvg, spo2Avg, respirationRateAvg } = this.props;
        let data = graphs;

console.log('dateeeeeeeeee',date);

        let labels=[];
            const DATA_COUNT = dataPointsArray.length;
            // const labels = [];
...
function mapStateToProps({ GraphApp }) {
    ...
    return {
        ...
        heartRateAvg: GraphApp.GraphReducer.heartRateAvg,
        bodyTemperatureAvg: GraphApp.GraphReducer.bodyTemperatureAvg,
        sbpAvg: GraphApp.GraphReducer.sbpAvg,
        dbpAvg: GraphApp.GraphReducer.dbpAvg,
        spo2Avg: GraphApp.GraphReducer.spo2Avg,
        respirationRateAvg: GraphApp.GraphReducer.respirationRateAvg,
        time: GraphApp.GraphReducer.time,
        date: GraphApp.GraphReducer.date
